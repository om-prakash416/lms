...
<body>
  <section id="title-header">
    <div class="title" style="background-color: white; width:100%; justify-content: center;  ; ">
      ...
      <img src="./images/CPC_Logo.png" height="100px" />
    </div>
  </section>
  <section id="navigation">
    <div id="mySidenav" class="sidenav">
      ...
      <!--<a href="<?php echo web_root; ?>admin/modules/course/index.php" >Course<i class="fa fa-download pull-right"></i></a>-->

      <a href="<?php echo web_root; ?>index.php?q=about" id="paid-course">Courses<i class="fas fa-video pull-right"></i></a>
  ...
  <section id="footer">
    ...
    <footer>
      <p align="center">&copy; Cimage Professional College </p>
    </footer>
  </section>
