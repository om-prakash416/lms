...
<head>
  ...
  <title>Cimage Course World</title>
  ...
  <style type="text/css">
    ...
    .navbar {
      background: linear-gradient(90deg, rgba(2, 0, 36, 1) 0%, rgba(18, 18, 125, 1) 57%, rgba(0, 212, 255, 1) 100%);
      border-radius: 0;
      padding: 10px;
    }
...
<body>
  <section id="navigation">
    <nav class="navbar navbar-default  " role="navigation" style="margin-top: 0px;">
      ...
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="<?php echo web_root; ?>admin/index.php">Cimage Course World</a>
      </div>

      <ul class="nav navbar-top-links navbar-right">
        <li class="dropdown">
          <a class="dropdown-toggle" data-toggle="dropdown" style="color: white !important; font-weight:bold; font-size:16px">
            <i class="fa fa-user fa-fw"></i> <?php echo $_SESSION['NAME']; ?>
          </a>

        </li>
        <li><a href="<?php echo web_root; ?>admin/logout.php" style="color: white !important; font-weight:bold; font-size:16px"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
        </li>
      </ul>

      <div class="navbar-default sidebar" role="navigation"  >
        <div class="sidebar-nav navbar-collapse" >
          <ul class="nav" id="side-menu" style="padding: 15px;" >
            ...
            <li style="padding: 10px;"><a href="<?php echo web_root; ?>admin/modules/user/index.php"><i class="fa fa-user fa-fw"></i> Manage Users</a></li>
            ...
            <li style="padding: 10px;">
              <a href="<?php echo web_root; ?>admin/modules/course/admin/add_course.php"><i class="fa fa-user fa-fw"></i>Add Course</a>
            </li>
            <li style="padding: 10px;">
              <a href="<?php echo web_root; ?>admin/modules/course/admin/admin-crud.php"><i class="fa fa-user fa-fw"></i>Manage Course</a>
            </li>
            <li style="padding: 10px;">
              <a href="<?php echo web_root; ?>#"><i class="fa fa-user fa-fw"></i>Paid Course</a>
            </li>
  ...
  <section id="page-footer">
    <footer>
      <p align="center">&copy; COMPUTER AIDED INSTRUCTION IN WORLD LITERATURE </p>
    </footer>
  </section>
  <!-- Plugins -->
